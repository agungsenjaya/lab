		...
		<div class="card shadow">
			<div class="card-body">
				<div class="d-flex justify-content-between mb-4">
					<div>
						<h4 class="title-3 text-uppercase fw-bold mb-0 text-lab">Table Pasien</h4>
				...
				<table id="table1" class="table table-striped w-100 table-bordered">
						<thead class="title-3 text-uppercase text-lab">
							<tr>
								...
								<th scope="col" class="border-top-0 py-2">Kode</th>
						...
						<tbody class="font-size-1 text-capitalize">@foreach($pasien->reverse() as $pas)
							<tr>
								...
								<td><i class="text-lab bi bi-activity me-2"></i>{{ $pas->formula->judul }}</td>

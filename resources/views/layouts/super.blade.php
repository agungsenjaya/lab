          ...
          <div class="">
            <div class="row g-0">
              ...
              <a href="javascript:void(0)" class="list-group-item list-group-item-action d-flex justify-content-between" data-bs-toggle="collapse" data-bs-target="#nav-3" aria-expanded="false">
                ...
                <a href="{{ route('super.cabang_detail') }}" class="list-group-item list-group-item-action {{ (Route::currentRouteName() == 'super.cabang_detail')? 'active-res' : '' }}">
                  <i class="bi bi-bank2 me-3"></i>Detail Cabang
                </a>
                <a href="{{ route('super.account') }}" class="list-group-item list-group-item-action {{ (Route::currentRouteName() == 'super.account')? 'active-res' : '' }}">

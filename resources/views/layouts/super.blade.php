        ...
        <section class="">
          <div class="">
            <div class="row g-0">
              ...
              <nav class="navbar navbar-light bg-lab-2 py-1">
              <div class="container">
              ...
              <div class="list-group list-group-flush nav-res">
                ...
                <a href="#" class="list-group-item list-group-item-action" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalLogout">Logout</a>
                            </li>
                        @endguest
                    </ul>
                </div>

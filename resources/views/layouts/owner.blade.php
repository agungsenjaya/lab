          ...
          <div class="">
            <div class="row g-0">
              ...
              <a href="javascript:void(0)" class="list-group-item list-group-item-action d-flex justify-content-between" data-bs-toggle="collapse" data-bs-target="#nav-2" aria-expanded="false">
                ...
                <div class="list-group list-group-flush nav-res">
                  <a href="{{ route('owner.cabang') }}" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Table Cabang</a>
                  <a href="{{ route('owner.cabang_new') }}" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Tambah Cabang</a>
                </div>
              ...
              <a href="javascript:void(0)" class="list-group-item list-group-item-action d-flex justify-content-between" data-bs-toggle="collapse" data-bs-target="#nav-3" aria-expanded="false">
                ...
                <div class="collapse bg-lab-2 {{ (Route::currentRouteName() == 'owner.user' || 'owner.user_edit' || 'owner.user_new') ?  'show' : '' }}" id="nav-3" style="">

                <div class="list-group list-group-flush nav-res">
                  <a href="{{ route('owner.user') }}" class="list-group-item list-group-item-action {{ (Route::currentRouteName() == 'owner.user' || 'owner.user_edit' ) ? 'active-res' : '' }}"><i class="bi bi-dot me-3"></i>Table User</a>

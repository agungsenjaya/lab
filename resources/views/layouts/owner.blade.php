          ...
          <div class="">
            <div class="row g-0">
              ...
              <div class="list-group list-group-flush nav-res">
                ...
                <div class="list-group list-group-flush nav-res">
                  <a href="javascript:void(0)" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Table Pasien</a>
                  <a href="javascript:void(0)" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Cari Pasien</a>
                </div>

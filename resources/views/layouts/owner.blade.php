          ...
          <div class="">
            <div class="row g-0">
              ...
              <div class="list-group list-group-flush nav-res">
                ...
                <div class="collapse bg-lab-2" id="nav-1" style="">

                <div class="list-group list-group-flush nav-res">
                  <a href="javascript:void(0)" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Table User</a>
                  <a href="javascript:void(0)" class="list-group-item list-group-item-action"><i class="bi bi-dot me-3"></i>Cari User</a>
                </div>
